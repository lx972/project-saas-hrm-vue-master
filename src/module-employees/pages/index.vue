  ...
  <div class="dashboard-container">
    <div class="app-container">
      <el-card>
        <span class="seleInfo">
          <el-select v-model="requestParameters.stausInfo">
            <el-option
              v-for="item in baseData.stausInfos"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            >
        ...
        <div class="fr">
          <router-link
            :to="{ path: '/employees/import/', query: { name: '员工' } }"
          ...
          <router-link
            :to="{ path: '/employees/archiving/' }"
            class="el-button el-button--primary el-button--mini"
            title="历史归档"
            >历史归档</router-link
          >
          <router-link
            :to="{ path: '/employees/report/1' }"
            class="el-button el-button--primary el-button--mini"
            >1月份报表</router-link
          >
          <el-button
      ...
      <el-card shadow="never" class="boxMar">
        <el-table :data="dataList" fit style="width: 100%" border>
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button @click="handleRole(scope.row.id)" type="text" size="small"
                >分配角色</el-button
              >
              <el-button
        ...
        <!-- 新增员工弹层 -->
        <component
          v-bind:is="employeesAdd"
          ref="addUser"
          @doQuery="doQuery"
        ></component>
        <!--分配角色组件 -->
        <component
          v-bind:is="rolesUpdate"
          ref="updateRole"
          @doQuery="doQuery"
        ></component>
      </el-card>
...
import rolesUpdate from "./../components/role";
export default {
  name: "employeesList",
  components: {
    PageTool,
  ...
  methods: {
    ...
    // 分配角色
    handleRole(id) {
      this.$refs.updateRole.dialogFormVisible = true;
      this.$refs.updateRole.userId = id;
      console.log("id:"+id);
    },
    // 添加新员工
    handlAdd() {
