    ...
    <el-dialog title="编辑员工" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="formBase" label-position="left" label-width="120px" style='margin-left:120px; width:500px;'>
        ...
        <el-form-item label="入职时间：">
          <el-date-picker v-model="formBase.timeOfEntry" type="datetime" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="转正时间：">
          <el-date-picker v-model="formBase.correctionTime" type="datetime" placeholder="选择日期"  value-format="yyyy-MM-dd HH:mm:ss">
          </el-date-picker>
        </el-form-item>
      </el-form>
...
export default {
  ...
  created: function() {
   departmentApi.getTree().then((ret) => {
      this.depts = ret.data.data.depts;
    });
  }
}
</script>
